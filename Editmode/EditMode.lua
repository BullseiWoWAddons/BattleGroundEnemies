...
function BattleGroundEnemies.EditMode.EditModeManager:AddFrame(frame, systemName, systemNameLocalized, playerButton)
	...
	Mixin(frame.Selection, BattleGroundEnemies.Mixins.EditModeSystemSelectionBaseMixin, BattleGroundEnemies.Mixins.EditModeSystemSelectionMixin, BattleGroundEnemies.Mixins.CustomEditModeSystemSelectionMixin	)
